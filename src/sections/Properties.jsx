...
const Properties = () => {
  ...
  return (
    <div className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'}`}>
      <section id='properties' className='lg:w-[90%] m-auto lg:pc-20 px-6 py-20 w-full flex felx-col justify-center items-start gap-10'>
        <div className='felx felx-col justify-center items-start gap-4'>
            ...
            property.map((item, index) => (
              <div data-aos='zoom-in' data-aos-delay='200' key={index} className='bg-white dark:bg-gray-800 rounded-xl w-full'>
                ...
                <div className='px-6 py-3 flex flex-col justify-center items-start gap-2 w-full'>
                  ...
                  <h1 className='text-2xl text-red-600 font-bold dark:text-white'>{item.name}</h1>
                  ...
                  <div id='owner-info' className='flex justify-between items-center wifull mt-2'>
                    <div className='flex justify-center items-center gap-2'>
                      <FaUserCircle className='size-5 text-red-400'/>
                      <h1 className='dark:text-white'>{item.owner}</h1>
                    </div>
                    <div className='flex justify-center items-center gap-4'>
                      <div className='p-2 border-gray-200 hover:bg-black cursor-pointer tranform hover:scale-110 transition-transform duration-300'>
                        <FaShareAlt className='size-4 text-red-400'/>
                      </div>
                      <div className='p-2 border-gray-200 hover:bg-black cursor-pointer tranform hover:scale-110 transition-transform duration-300'>
                        <FaHeart className='size-4 text-red-400'/>
                      </div><div className='p-2 border-gray-200 hover:bg-black cursor-pointer tranform hover:scale-110 transition-transform duration-300'>
