    ...
    <section id='about' className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'} w-full m-auto lg:px-40 px-10 py-20 grid lg:grid-cols-2 grid-cols-1 justify-center items-center gap-10`}>
      ...
      <div className='flex flex-col justify-center items-start gap-8'>
        ...
        <h1 data-aos='zoom-in' data-aos-delay='200' className='text-black text-[40px] font-semibold leading-10 dark:text-white'>
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nihil fugiat animi ullam, nesciunt voluptatum iure.
        </h1>
        <p data-aos='zoom-in' data-aos-delay='400' className='text-xl text-gray-600 dark:text-white text-just'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Animi rem, soluta mollitia perspiciatis hic velit. Quidem qui, quo suscipit officia saepe odit minus cupiditate. Cum ratione sequi nostrum enim dolor aperiam veritatis reprehenderit quisquam voluptates?
        </p>
