    ...
    <div className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'} pb-20`}>
      <section id='contact'  className={`${darkMode ? 'dark bg-gray-800' : 'light bg-red-100'} lg:w-[95%] w-full h-fit m-auto rounded-xl grid lg:grid-cols-2 grid-cols-1 justify-center items-center lg:px-36 px-6 py-20 gap-10`}>
        <div data-aos='zoom-in' className='bg-white dark:bg-black p-10 flex flex-col justify-center items-start gap-4 rounded-xl'>
          ...
          <input type='email' placeholder='Enter your valid mail' className='w-full px-6 py-3 border-2 border-gray-200 rounded-xl'/>
          ...
          <textarea name='' id='' cols='30' rows='5' placeholder='Enter your message here....' className='w-full px-6 border-2  border-gray-200 rounded-xl'></textarea>
        ...
        <div className='flex flex-col justify-center items-start gap-8 lg:p-20 p-6'>
          ...
          <h1 data-aos='zoom-in' data-aos-delay='400' className='text-black text-[40px] font-semibold leading-10 dark:text-white'>Lorem ipsum, dolor sit amet consectetur adipisicing elit.</h1>
          <p data-aos='zoom-in' data-aos-delay='600' className='text-xl text-gra-600 text-justify dark:text-white'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Porro iure harum illum corporis repellendus consectetur nemo vero ipsa alias, velit ad, ex laudantium assumenda amet, temporibus delectus quos omnis aspernatur!</p>
