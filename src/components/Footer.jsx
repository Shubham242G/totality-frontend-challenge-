...
const Footer = () => {
  ...
  return (
    <div>
      <footer className={`${darkMode ? 'dark bg-black' : 'light bg-gray-800'} w-full m-auto lg:px-20 px-10 py-20 grid lg:grid-cols-3 grid-cols-1 justify-center items-center lg:gap-20 gap-10`}>
        <div className='flex flex-col justify-center items-start gap-5'>r
          <h1 className='text-white text-2xl font-semibold'>About Us</h1>
          <p className='text-slate-200 text-justify'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit libero deleniti ex suscipit, praesentium iusto? Eligendi ut inventore aliquam illum.</p>
          ...
          <div className='flex flex-col justify-center items-start gap-5'>
            ...
            <div className='flex justify-center items-center gap-3'>
              <FaBuilding className='text-white size-5'/>
               <p className='text-slate-200'>Lorem ipsum dolor sit amet consectetur adiphh hdcs</p>
            </div>
            <div className='flex justify-center items-center gap-3'>
              <FaMobile className='text-white size-5'/>
               <p className='text-slate-200'>+91-3983409532</p>
            </div>
            <div className='flex justify-center items-center gap-3'>
              <FaFax className='text-white size-5'/>
               <p className='text-slate-200'>45539 34958</p>
            </div>
            <div className='flex justify-center items-center gap-3'>
      ...
      <div>
        <button onClick={toggleDarkMode} className='flex items-center p-4 rounded-full bg-orange-500 fixed lg:top-52 right-6 top-15'>
